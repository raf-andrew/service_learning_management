...
return array(
    ...
    'App\\Console\\Commands\\DockerCommand' => $baseDir . '/app/Console/Commands/DockerCommand.php',
    'App\\Console\\Commands\\GenerateDocsCommand' => $baseDir . '/app/Console/Commands/GenerateDocsCommand.php',
    ...
    'MCP\\Agentic\\Agents\\Operations\\MaintenanceAgent' => $baseDir . '/src/MCP/Agentic/Agents/Operations/MaintenanceAgent.php',
    'MCP\\Agentic\\Agents\\Security\\AccessControlAgent' => $baseDir . '/src/MCP/Agentic/Agents/Security/AccessControlAgent.php',
    'MCP\\Agentic\\Agents\\Security\\AuditAgent' => $baseDir . '/src/MCP/Agentic/Agents/Security/AuditAgent.php',
    'MCP\\Agentic\\Core\\Services\\BillingService' => $baseDir . '/src/MCP/Agentic/Core/Services/BillingService.php',
    'MCP\\Agentic\\Core\\Services\\EncryptionService' => $baseDir . '/src/MCP/Agentic/Core/Services/EncryptionService.php',
    'MCP\\Agentic\\Core\\Services\\TenantService' => $baseDir . '/src/MCP/Agentic/Core/Services/TenantService.php',
    'MCP\\Agents\\Development\\CodeAnalysis\\CodeCoverageAnalysisAgent' => $baseDir . '/src/MCP/Agents/Development/CodeAnalysis/CodeCoverageAnalysisAgent.php',
    'MCP\\Agents\\Development\\CodeAnalysis\\CodeQualityMetricsAgent' => $baseDir . '/src/MCP/Agents/Development/CodeAnalysis/CodeQualityMetricsAgent.php',
    'MCP\\Agents\\Development\\CodeAnalysis\\CodeStyleAnalysisAgent' => $baseDir . '/src/MCP/Agents/Development/CodeAnalysis/CodeStyleAnalysisAgent.php',
    'MCP\\Agents\\Development\\CodeAnalysis\\DependencyAnalysisAgent' => $baseDir . '/src/MCP/Agents/Development/CodeAnalysis/DependencyAnalysisAgent.php',
    'MCP\\Agents\\Development\\CodeAnalysis\\SecurityVulnerabilityScanningAgent' => $baseDir . '/src/MCP/Agents/Development/CodeAnalysis/SecurityVulnerabilityScanningAgent.php',
    'MCP\\Agents\\Development\\CodeGeneration\\CodeGenerationAgent' => $baseDir . '/src/MCP/Agents/Development/CodeGeneration/CodeGenerationAgent.php',
    'MCP\\Agents\\Development\\CodeRefactoring\\CodeRefactoringAgent' => $baseDir . '/src/MCP/Agents/Development/CodeRefactoring/CodeRefactoringAgent.php',
    'MCP\\Controllers\\BaseController' => $baseDir . '/src/MCP/Controllers/BaseController.php',
    'MCP\\Controllers\\Controller' => $baseDir . '/src/MCP/Controllers/Controller.php',
    'MCP\\Core\\Config\\Config' => $baseDir . '/src/MCP/Core/Config/Config.php',
    'MCP\\Core\\Database\\ConnectionManager' => $baseDir . '/src/MCP/Core/Database/ConnectionManager.php',
    'MCP\\Core\\DeploymentAutomationAgent' => $baseDir . '/src/MCP/Core/DeploymentAutomationAgent.php',
    'MCP\\Core\\Logger\\Logger' => $baseDir . '/src/MCP/Core/Logger/Logger.php',
    'MCP\\Core\\ServiceHealthAgent' => $baseDir . '/src/MCP/Core/ServiceHealthAgent.php',
    'MCP\\Exceptions\\AuthenticationException' => $baseDir . '/src/MCP/Exceptions/AuthenticationException.php',
    'MCP\\Exceptions\\AuthorizationException' => $baseDir . '/src/MCP/Exceptions/AuthorizationException.php',
    'MCP\\Exceptions\\CsrfException' => $baseDir . '/src/MCP/Exceptions/CsrfException.php',
    'MCP\\Exceptions\\SqlInjectionException' => $baseDir . '/src/MCP/Exceptions/SqlInjectionException.php',
    'MCP\\Exceptions\\XssException' => $baseDir . '/src/MCP/Exceptions/XssException.php',
    'MCP\\Interfaces\\Authenticatable' => $baseDir . '/src/MCP/Interfaces/Authenticatable.php',
    'MCP\\Models\\BaseModel' => $baseDir . '/src/MCP/Models/BaseModel.php',
    'MCP\\Models\\Model' => $baseDir . '/src/MCP/Models/Model.php',
    'MCP\\Presenters\\BasePresenter' => $baseDir . '/src/MCP/Presenters/BasePresenter.php',
    'MCP\\Presenters\\Presenter' => $baseDir . '/src/MCP/Presenters/Presenter.php',
    'MCP\\Security\\Authentication' => $baseDir . '/src/MCP/Security/Authentication.php',
    'MCP\\Security\\Middleware\\AuthorizationMiddleware' => $baseDir . '/src/MCP/Security/Middleware/AuthorizationMiddleware.php',
    'MCP\\Security\\Middleware\\CsrfMiddleware' => $baseDir . '/src/MCP/Security/Middleware/CsrfMiddleware.php',
    'MCP\\Security\\Middleware\\SqlInjectionMiddleware' => $baseDir . '/src/MCP/Security/Middleware/SqlInjectionMiddleware.php',
    'MCP\\Security\\Middleware\\XssMiddleware' => $baseDir . '/src/MCP/Security/Middleware/XssMiddleware.php',
    ...
    'Tests\\TestRunner' => $baseDir . '/tests/TestRunner.php',
